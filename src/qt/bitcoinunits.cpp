...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MBT");
    case mBTC: return QString("mMBT");
    case uBTC: return QString::fromUtf8("μMBT");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("MBITs"));
    case mBTC: return QString(QObject::tr("Milli-MBITs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-MBITs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
